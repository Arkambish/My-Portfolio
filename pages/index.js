  ...
  return (
    <div className="bg-primary/60 h-full">
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        <div className="text-center flex flex-col justify-center xl:pt-[100px] xl:text-left h-full container mx-auto pt-24">
          <motion.h1
          ...
          <motion.h2
            ...
            animate="show"
            exit="hidden"
            className="h2 text-4xl relative" // Added relative positioning
          >
            {typedText}
